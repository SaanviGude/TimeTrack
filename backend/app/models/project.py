...
class Project(BaseModel):
    ...
    name = Column(String, index=True, nullable=False, comment="Name of the project")
    description = Column(Text, nullable=True, comment="Description of the project")
    deadline = Column(DateTime(timezone=True), nullable=True, comment="Optional project deadline (UTC)")
